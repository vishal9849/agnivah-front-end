<script lang="ts">
  // Company stats for the metrics section
  const companyStats = [
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      role: "CTO",
      image: "/twitter.svg",
      bio: "Sam leads our technical strategy and oversees all development and innovation initiatives.",
    },
    {
      name: "Taylor Morgan",
      role: "Design Director",
      image: "/google.svg",
      bio: "Taylor ensures our products maintain the highest design standards and user experience.",
    },
    {
      name: "Jordan Lee",
      role: "Operations Manager",
      image: "/github.svg",
      bio: "Jordan keeps everything running smoothly, from project management to client relations.",
    },
  ];

  export let about_us_svg = "./about-us.svg"; // Logo source for the hero section
</script>
  ...
  <main class="flex-grow">
    ...
    <div class="bg-gray-800 border-none">
      <div class="container mx-auto px-4 py-20 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-6 text-orange-300">
          About Our Company
        </h1>
      ...
      <div class="flex flex-col md:flex-row gap-12 items-center">
        <div class="md:w-1/2">
          ...
          <div class="space-y-4 text-gray-300">
            <p>
              Founded in 2012, our company began with a simple mission: to build
              technology that makes a difference. What started as a small team
              of three passionate developers has grown into a global company
              serving clients across multiple industries.
            </p>

            <p>
              Throughout our journey, we've remained committed to our core
              values of innovation, quality, and client satisfaction. We believe
              that technology should simplify and enhance people's lives, not
              complicate them.
            </p>

            <p>
              Today, we're proud to have a diverse team of experts who bring
              their unique perspectives and talents to every project. Our
              collaborative approach allows us to tackle complex challenges and
    ...
    <section class="bg-gray-800 py-16">
      <div class="container mx-auto px-4 text-center">
        <h2 class="text-3xl text-gray-100 font-bold mb-6">
