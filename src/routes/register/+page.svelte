...
<div class="flex items-center justify-center min-h-screen bg-gray-800">
  <div
    class="relative flex flex-col m-6 space-y-8 bg-gray-950 hover:bg-gray-900 shadow-2xl rounded-2xl md:flex-row md:space-y-0 transition-all duration-600"
  >
    <!-- left side -->
      ...
      {:else}
        <div class="max-w-md mx-auto">
          ...
          <form class="mt-8 space-y-6" on:submit|preventDefault={handleSubmit}>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                <label
                  for="firstName"
                  class="block text-sm font-medium text-gray-300 ml-1 mb-1"
                  >First Name</label
                >
                <input
                  type="text"
            ...
            <div class="flex items-start">
              ...
              />
              <label for="agreeTerms" class="ml-2 block text-sm text-gray-400">
                I agree to the
                <a href="/item5" class="text-blue-600 hover:text-blue-500"
                  >Terms and Conditions</a
                >
                and
                <a href="/item6" class="text-blue-600 hover:text-blue-500"
                  >Privacy Policy</a
                >
              </label>
            </div>
            {#if errors.agreeTerms}
              <p class="mt-1 text-sm text-red-400">{errors.agreeTerms}</p>
            {/if}
              ...
              <button
                ...
                class="w-full flex justify-center py-2 px-4 border
						  border-transparent rounded-md shadow-sm text-sm font-medium
						   text-gray-100 bg-blue-600 hover:bg-blue-400 hover:scale-105 transition-all duration-300"
          ...
          <div class="text-sm text-center mt-6">
            ...
            <a
              href="/login"
              class="font-medium text-gray-100 ">Sign in</a
            >
          </div>
        </div>
      {/if}
